<powershell>
 ...
 $env:CHEF_SERVER_NAME = "Chef-Automate-us-east-1" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "chef-automate-us-east-1-ncmov8e4otrxfd3l.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
